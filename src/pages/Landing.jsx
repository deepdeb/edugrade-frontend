        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
            ...
            <div className="w-full lg:max-w-xl space-y-5 text-center lg:text-left">
              ...
              <Button title={"Get Started"} onClick={() => navigate('/register')} className="w-full lg:w-auto" />
            </div>

            {/* Image */}
            <div className="relative hidden shadow-md lg:flex w-full lg:w-1/2 rounded-lg justify-end p-3 bg-white">
              <img src="https://images.pexels.com/photos/1438081/pexels-photo-1438081.jpeg" alt="Learning" className='w-full rounded-lg object-cover' />
